...
public class MenuTestDrive {
	public static void main(String args[]) {
		...
		kfcMenu.add(piSa);
		kfcMenu.add(yiMian);
		MenuComponent keLe =  new MenuItem("可口可乐", "一种黑色饮料", 3.00, false);
		MenuComponent bingJiLin =  new MenuItem("冰淇淋", "一种冷饮", 5.00, false);
		MenuComponent guoZhi =  new MenuItem("果汁", "一种水果榨汁饮料",  10.00, false);
		MenuComponent piJiu =  new MenuItem("啤酒", "一种低度酒精饮料", 5.00, false);
		ziCaiDan.add(keLe);
		ziCaiDan.add(bingJiLin);
		ziCaiDan.add(guoZhi);
		ziCaiDan.add(piJiu);

		MenuComponent rouJiaBing =  new MenuItem("肉夹饼", "肉夹馍", 8.00, true);
		MenuComponent paoMo =  new MenuItem("羊肉泡馍", "陕西美食", 20.00, true);
		MenuComponent JianBing =  new MenuItem("土豆丝煎饼", "一种薄饼",  10.00, false);
		MenuComponent danJiaBing =  new MenuItem("蛋夹饼", "蛋夹馍", 5.00, false);
